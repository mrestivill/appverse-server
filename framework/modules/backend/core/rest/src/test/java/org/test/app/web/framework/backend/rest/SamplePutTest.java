...
public class SamplePutTest extends JerseyTest {
	...
	public void updateSample() throws Exception {
		...
		dto = jsonSampleRepository.updateSample(dto);
		assertNotNull(dto);
		assertEquals(dto.getId(), 4l);
	}

	@Test
	public void updateSampleStatusReturn() throws Exception {
		SampleDTO dto = new SampleDTO(4, 34, "newSample", "newSurname");
		StatusResult status = jsonSampleRepository.updateSampleStatus(dto);
	...
	@Test
	public void updateSampleXml() throws Exception {
		SampleDTO dto = new SampleDTO(4, 34, "newSample", "newSurname");
		dto = xmlSampleRepository.updateSample(dto);
		assertNotNull(dto);
		assertEquals(dto.getId(), 4l);
	}

	@Test
	public void updateSampleStatusReturnXml() throws Exception {
		SampleDTO dto = new SampleDTO(4, 34, "newSample", "newSurname");
		StatusResult status = xmlSampleRepository.updateSampleStatus(dto);
